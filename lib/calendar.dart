...
class MonthCalendar extends StatefulWidget {
  const MonthCalendar({super.key, required this.today, required this.onMonthChanged});
...
final List<DateTime> _selectedDays = [DateTime(2023, 12, 5), DateTime(2023, 12, 6), DateTime(2023, 12, 7), DateTime(2023, 12, 8), DateTime(2023, 12, 9), DateTime(2023, 12, 10), DateTime(2023, 12, 11), DateTime(2023, 12, 12), DateTime(2023, 12, 14), DateTime(2023, 12, 15), DateTime(2023, 12, 16), DateTime(2023, 12, 18), DateTime(2023, 12, 24), DateTime(2023, 12, 25), DateTime(2023, 12, 26)];
        ...
        TableCalendar(
          ...
          calendarStyle: CalendarStyle(
            ...
            todayDecoration: BoxDecoration(
              color: _selectedDays.contains(_today) ? Color(0xffD9D9D9) : Colors.transparent,
              border: Border.all(width: 2),
              borderRadius: BorderRadius.circular(25)),
            selectedDecoration: BoxDecoration(
              color: Color(0xffD9D9D9),
              border: _selectedDays.contains(_today) ? Border.all(width: 2) : null,
              borderRadius: BorderRadius.circular(25)
            ),
